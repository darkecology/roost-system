# Adapted from https://github.com/facebookresearch/detectron2/blob/main/detectron2/modeling/backbone/fpn.py
...
def build_adaptor_resnet_fpn_backbone(cfg, input_shape: ShapeSpec):
    ...
    """
    class input_shape(object): pass
    input_shape.channels = 3  # to override the shape of the input array (4+ channels)
...
# custom augmentations for 4+ channel arrays
...
# same as detectron2.engine.DefaultPredictor but use CustomResize
...
# allow ndarray segmentation masks
def transform_instance_annotations(
    ...
    if "segmentation" in annotation:
        ...
        if isinstance(segm, list):
            ...
            assert tuple(segm.shape[:2]) == image_size
