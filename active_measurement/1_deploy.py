...
args.check_img_exist = False  # Unique to active measurement experiments.
...
# directories
DIRS = {
    # share by different finetuned models
    "scan_dir":                   os.path.join(os.path.dirname(args.data_root), 'scans'),  # raw scans downloaded from AWS
    "npz_dir":                    os.path.join(os.path.dirname(args.data_root), 'arrays'), # rendered npz file
    # specific to each finetuned model
